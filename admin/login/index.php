        ...
        <div class="nk-block toggled" id="l-login">
            ...
            <div class="nk-form">
                <div class="input-group">
                    ...
                    <div class="nk-int-st">
                        <input type="text" class="form-control" name="username" placeholder="Admin" value="admin">
                    </div>
                </div>
                ...
                <button class="btn btn-login btn-success btn-float" name="login"> 
                    <i class="notika-icon notika-right-arrow right-arrow-ant"></i>
                    
                </butto>
                <!-- <a href="#l-register" data-ma-action="nk-login-switch" data-ma-block="#l-register" </a> -->
            </div>
            </form>
